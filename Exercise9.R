...
# works only if the directory contains files that have the same separator (here the user can choose between comma or tab separated files)


VarCoefficient <- function(dir, column, observations = 0) {
  setwd(dir)
...
VarCoefficient("/Users/johi/Desktop/Courses/Biocomputing/r-novice-inflammation/infl_data", 2, observations = 1)
